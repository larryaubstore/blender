...
static void edge_queue_insert(EdgeQueue *q,
							  BLI_mempool *pool,
							  BMEdge *e,
							  float priority)
{
...
static void long_edge_queue_edge_add(EdgeQueue *q,
									 BLI_mempool *pool,
									 BMEdge *e)
{
...
static void short_edge_queue_edge_add(EdgeQueue *q,
									  BLI_mempool *pool,
									  BMEdge *e)
{
	const float len_sq = BM_edge_calc_squared_length(e);
...
static int long_edge_queue_face_add(EdgeQueue *q,
									BLI_mempool *pool,
									BMFace *f)
{
	BMIter bm_iter;
...
static int short_edge_queue_face_add(EdgeQueue *q,
									 BLI_mempool *pool,
									 BMFace *f)
{
	BMIter bm_iter;
...
*/
static void long_edge_queue_create(EdgeQueue *q,
								   BLI_mempool *pool,
								   PBVH *bvh,
...
*/
static void short_edge_queue_create(EdgeQueue *q,
									BLI_mempool *pool,
									PBVH *bvh,
									const float center[3],
									float radius)
